    ...
    <div className="relative">
      ...
      <div className="container mx-auto px-4 py-16 text-text-primary relative z-10 pointer-events-none">
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold inline-block bg-[var(--color-background-secondary)] px-8 py-4 rounded-lg pointer-events-auto shadow-sm">Industries We Serve</h1>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 pointer-events-auto">
