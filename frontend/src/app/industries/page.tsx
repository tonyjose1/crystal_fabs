  ...
  return (
    <div className="container mx-auto px-4 py-16 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
        <div className="bg-black p-6 rounded-lg shadow-md border border-transparent hover:border-[#3d579f] ">
      ...
      <div className="text-center mt-16">
        ...
        <Link href="/contact" className="bg-primary text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-[#3d579f] transition-colors">
            Get a Quote
        </Link>
      </div>
    </div>
