    ...
    <div>
      <div className="flex justify-center gap-4 mb-8">
        <input
          ...
          className="p-3 rounded-md w-full md:w-1/2 bg-[var(--color-background-secondary)] text-text-primary border border-[#3d579f] onclick:border-[#3d579f] placeholder-gray-500 focus:border-[#3d579f] focus:outline-none focus:ring-0"
        />
      </div>
