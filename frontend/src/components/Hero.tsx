    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center text-center z-10">
        <div className="relative">
          ...
          <Link href="/contact">
            <button className="mt-8 bg-primary text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-primarydark transition-all duration-300 transform hover:scale-105 animate-fade-in-up cursor-pointer">
              Get a Free Quote
            </button>
          </Link>
        </div>
